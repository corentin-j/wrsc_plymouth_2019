...
def sub_zone_to_stay(data): # Quaternion
	global zone_to_stay
...
if __name__ == "__main__":
	...
	marker_zone   = Marker_rviz("zone",(0,0,0),(0, 0, 0),(30,30,0.1),3,(0,0.5,0))
	...
	while not rospy.is_shutdown():
		...
		br_zone.sendTransform((zone_to_stay[0],zone_to_stay[1],-0.2),(quaternion_from_euler(0,0,0)),rospy.Time.now(),"zone","map")
